...
var format_2new_layer_3 = new ol.format.GeoJSON();
var features_2new_layer_3 = format_2new_layer_3.readFeatures(json_2new_layer_3, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_2new_layer_3 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_2new_layer_3.addFeatures(features_2new_layer_3);
var lyr_2new_layer_3 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_2new_layer_3, 
                style: style_2new_layer_3,
                popuplayertitle: 'границы2 — new_layer',
                interactive: true,
                title: 'границы2 — new_layer'
            });
...
lyr_YandexSatellite_0.setVisible(true);lyr_OSMStandard_1.setVisible(true);lyr_lab1_buidingslab1_buildings_2.setVisible(true);lyr_2new_layer_3.setVisible(true);lyr_lab1_highway_line_4.setVisible(true);lyr_lab1_highway_point_5.setVisible(true);
var layersList = [lyr_YandexSatellite_0,lyr_OSMStandard_1,lyr_lab1_buidingslab1_buildings_2,lyr_2new_layer_3,lyr_lab1_highway_line_4,lyr_lab1_highway_point_5];
...
lyr_2new_layer_3.set('fieldAliases', {'Name': 'Name', 'description': 'description', 'timestamp': 'timestamp', 'begin': 'begin', 'end': 'end', 'altitudeMode': 'altitudeMode', 'tessellate': 'tessellate', 'extrude': 'extrude', 'visibility': 'visibility', 'drawOrder': 'drawOrder', 'icon': 'icon', });
...
lyr_2new_layer_3.set('fieldLabels', {'Name': 'no label', 'description': 'no label', 'timestamp': 'no label', 'begin': 'no label', 'end': 'no label', 'altitudeMode': 'no label', 'tessellate': 'no label', 'extrude': 'no label', 'visibility': 'no label', 'drawOrder': 'no label', 'icon': 'no label', });
